...
public class SwipeAction {
 ...
 public void swipingHorizontal() throws InterruptedException {
  ...
  WebElement ele1 =  (WebElement) driver.findElementsById("android.widget.RelativeLayout").get(1);
  ...
  WebElement ele2 =  (WebElement) driver.findElementsById("android.widget.RelativeLayout").get(2);
